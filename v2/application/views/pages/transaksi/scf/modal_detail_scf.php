    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail SCF</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form method='post' action='<?= base_url() ?>transaksi/scf/editscf/'>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-5 modal-input">
                            ...
                            <div id='input-nominal_sesuai_bukti_kas-ubah' class="input-group">
                                ...
                                <input class="form-control input-number-ubah number-separator" id="nominal_sesuai_bukti_kas-ubah" name="nominal_sesuai_bukti_kas" style="text-align: right" value="0" onclick="this.value == 0 && this.select()" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-2 modal-input">
                            ...
                            <div id='input-tenor-ubah'>
                                <input type="number" class="form-control" id="tenor-ubah" name="tenor" min="0" value="0" onclick="this.value == 0 && this.select()" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6 modal-input">
                            ...
                            <div id='input-biaya_scf_pindad-ubah' class="input-group">
                                ...
                                <input class="form-control input-number-ubah number-separator" id="biaya_scf_pindad-ubah" name="biaya_scf_pindad" style="text-align: right" value="0" onclick="this.value == 0 && this.select()" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6 modal-input">
                            ...
                            <div id='input-biaya_scf_vendor-ubah' class="input-group">
                                ...
                                <input class="form-control input-number-ubah number-separator" id="biaya_scf_vendor-ubah" name="biaya_scf_vendor" style="text-align: right" value="0" onclick="this.value == 0 && this.select()" disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-6 modal-input">
                            ...
                            <div id='input-jumlah_nominal_biaya_scf_pindad-ubah' class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text justify-content-center" style='min-width:40px'>Rp.</span>
                                </div>
                                <input class="form-control input-number-ubah number-separator" id="jumlah_nominal_biaya_scf_pindad-ubah" name="jumlah_nominal_biaya_scf_pindad" style="text-align: right" value="0" disabled>
                            </div>
                        </div>
...
<script>
    ...
    function handleDisabled() {
        ...
        //Exception
        const except = ['biaya_scf', 'jumlah_nominal_biaya_scf', 'jumlah_nominal_biaya_scf_pindad'];
    ...
    $('#modalDetail').on('show.bs.modal', function(event) {
        ...
        xml.open('GET', `<?= base_url() ?>transaksi/scf/getDetailSCF/${id}`, false);
        xml.send();
        ...
        $("#tenor-ubah").val(data['tenor']).trigger('input');
    ...
    $(document).ready(function() {
        ...
        $("#biaya_scf_pindad-ubah, #nominal_sesuai_bukti_kas-ubah").on("input", function(e) {
            jumlahBiayaScfPindad = biayaScfPindad + nominalSesuaiBuktiKas;
            $("#jumlah_nominal_biaya_scf_pindad-ubah").val(toStringLocaleId(jumlahBiayaScfPindad)).trigger("input");
        })
        ...
        $("#tanggal_mulai_scf-ubah").on("input", function(e) {
            ...
            $("#tenor-ubah").val(tenor).trigger("input")
        ...
        // Biaya SCF Listener
        $("#tenor-ubah, #nominal_sesuai_bukti_kas-ubah").on("input", function(e) {
            biayaScf = ((tenor / 360) * ((85 / 1000) * nominalSesuaiBuktiKas)).toFixed(2);
