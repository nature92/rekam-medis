...
<div class="app-main__inner">
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Master <?= toTitle($menu) ?>
                    <div class="page-title-subheading"><?= $kat_menu ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    if ($hak_akses->can_read === 't' && !$maintenance) {
        $this->load->view('pages/master/components/data-master');
        $this->load->view('pages/master/components/data-log');
