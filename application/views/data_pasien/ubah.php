						...
						<div class="form-group">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									...
									<input type="text" class="form-control" id="alamat" name="alamat"  placeholder="Alamat" value="<?php echo $pasien['alamat'];?>" >
								</div>
							</div>
							<div class="form-group row">
							...
							<div class="form-group row">
								<div class="col-sm-10">
									...
									<a href="<?= base_url('data_pasien'); ?>" class="btn btn-success">Kembali</a>
								</div>
							</div>
						</form>
						</div>
