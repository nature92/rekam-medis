									...
									<div class="box box-primary">
										...
										<form action="<?= base_url('pembayaran/tambah_aksi'); ?>" method="post">
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<textarea type="text" class="form-control" id="id_periksa" name="tindakan" readonly rows="3"> <?php echo  $b->tindakan ?></textarea> 
												</div>
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<select class="form-control select2"  id="id_tarif" name="id_tarif"><option value=''>Pilih Jasa</option>
											...
											<table id="example2" class="table table-bordered table-hover ">
												...
												<tfoot>
													...
													<tr>  
														...
														<td><center> <a class="btn btn-warning" href="<?= base_url().'Pembayaran/hapus_detail_bayar/'.$kodebayar;?>">Batal</a> </center></td>
