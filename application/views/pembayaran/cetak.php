...
<table  id="example1" class="tbl">
	<tr align="center" border="1">
		<td colspan="3">
			...
			<h3><i>Klinik Pratama Rahardja</i></h3>
			<hr>
		</td>
	</tr>

	<tr>
		<td>Tanggal Periksa <hr> </td>
		<td>:<hr></td>
		<td><?php echo $periksa['tanggal'] ?> <hr> </td>
	</tr>
	
	<tr>
		<td>Kode Bayar <hr> </td>
		<td>:<hr></td>
		<td><?php echo $kd_bayar['kd_bayar'] ?> <hr> </td>
	</tr>
	...
	<tr>
		<td></td>
		<td></td>
		<td>Padalarang, <?php echo date("d M Y") ?></td>
	</tr>
